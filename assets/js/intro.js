...
tl.to(".intro", { y: "0%", duration: 1.5, delay: 1, opacity: 0 });
...
tl.fromTo(".icon", { opacity: 0 }, { opacity: 1, duration: 0.25, delay: 0.12 });
tl.fromTo(
  ".hero-img",
  { opacity: 0 },
...
tl.fromTo(".logo", { opacity: 0 }, { opacity: 1, duration: 0.35, delay: 0.15 });
tl.fromTo(
  ".main-paragraph-one",
  { opacity: 0 },
